...
def extract_train_gt_radiomics():
    # ================= 1. 路径准备 =================
    TRAIN_DIR = Path(r"F:\downstreamtasks\radiomics\train")  # 你的 142 个病人所在的目录
    YAML_PATH = Path(r"radiomics_features.yaml")  # 刚才保存的完美配置文件
    OUTPUT_CSV = Path(r"F:\downstreamtasks\radiomics\Train_GT_Features.csv")  # 最终生成的特征表
